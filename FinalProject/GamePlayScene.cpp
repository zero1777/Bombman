...
bool GamePlayScene::DebugMode = false;
const std::vector<Engine::Point> GamePlayScene::directions = { Engine::Point(-1, 0), Engine::Point(0, -1), Engine::Point(1, 0), Engine::Point(0, 1) };
const int GamePlayScene::MapWidth = 20, GamePlayScene::MapHeight = 13;
const int GamePlayScene::BlockSize = 64;
const Engine::Point GamePlayScene::SpawnGridPoint = Engine::Point(-1, 0);
const Engine::Point GamePlayScene::EndGridPoint = Engine::Point(MapWidth, MapHeight - 1);
const std::vector<int> GamePlayScene::code = { ALLEGRO_KEY_UP, ALLEGRO_KEY_UP, ALLEGRO_KEY_DOWN, ALLEGRO_KEY_DOWN,
									ALLEGRO_KEY_LEFT, ALLEGRO_KEY_RIGHT, ALLEGRO_KEY_LEFT, ALLEGRO_KEY_RIGHT,
									ALLEGRO_KEY_B, ALLEGRO_KEY_A, ALLEGRO_KEYMOD_SHIFT, ALLEGRO_KEY_ENTER };
Engine::Point GamePlayScene::GetClientSize() {
...
void GamePlayScene::OnMouseDown(int button, int mx, int my) {
...
void GamePlayScene::OnMouseMove(int mx, int my) {
...
void GamePlayScene::OnMouseUp(int button, int mx, int my) {
...
void GamePlayScene::OnKeyDown(int keyCode) {
...
int GamePlayScene::GetMoney() const {
	return money;
}
void GamePlayScene::EarnMoney(int money) {
	this->money += money;
	//UIMoney->Text = std::string("$") + std::to_string(this->money);
}
void GamePlayScene::ReadMap() {
...
void GamePlayScene::ReadEnemyWave() {
...
void GamePlayScene::ConstructUI() {
	// Background
	...
	btn->SetOnClickCallback(std::bind(&GamePlayScene::UIBtnClicked, this, 0));
	...
	btn->SetOnClickCallback(std::bind(&GamePlayScene::UIBtnClicked, this, 1));
	UIGroup->AddNewControlObject(btn);
	// Button 3
	btn = new TurretButton("play/floor.png", "play/dirt.png",
	...
	btn->SetOnClickCallback(std::bind(&GamePlayScene::UIBtnClicked, this, 2));
	UIGroup->AddNewControlObject(btn);
	...
	btn->SetOnClickCallback(std::bind(&GamePlayScene::UIBtnClicked, this, 3));
	UIGroup->AddNewControlObject(btn);
}

void GamePlayScene::UIBtnClicked(int id) {
	if (preview)
		UIGroup->RemoveObject(preview->GetObjectIterator());
...
bool GamePlayScene::CheckSpaceValid(int x, int y) {
...
std::vector<std::vector<int>> GamePlayScene::CalculateBFSDistance() {
